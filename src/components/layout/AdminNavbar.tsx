      ...
      <nav className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-8 items-center">
          ...
          <Link href="/strategies-library">
            <span className={`${location.startsWith("/strategies") ? "text-primary" : "text-gray-300"} hover:text-accent transition cursor-pointer`}>
              Strategies
            </span>
          </Link>
          <div className="relative group">
            <Link href="/download">
              <span className={`${location.startsWith("/download") ? "text-primary" : "text-gray-300"} hover:text-accent transition cursor-pointer flex items-center`}>
                Downloads
          ...
          <Link href="/how-to">
            <span className={`${location.startsWith("/how-to") ? "text-primary" : "text-gray-300"} hover:text-accent transition cursor-pointer`}>
              How-To
            </span>
          </Link>
        </div>
